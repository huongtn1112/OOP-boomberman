...
public class Enemy3 extends Balloom {
    public Enemy3(PlayScreen screen, Rectangle bounds) {
        super();
        ...
        isHit = false;
        texture = new Texture(("Item/e3.png"));
        setTexture(texture);
    ...
    public void render(SpriteBatch sb) {
        sb.begin();
        sb.draw(texture, getTexX(), getTexY(), 16 / PPM, 16 / PPM);
        sb.end();
